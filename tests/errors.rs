...
use {common::*, libtransact::*, pretty_assertions::assert_eq};
...
//
#[test]
fn locked_charge_back() -> DynResult {
    let input = "
...
//
#[test]
fn dup_deposit_deposit() -> DynResult {
    let input = "
...
//
#[test]
fn dup_deposit_withdraw_deposit() -> DynResult {
    let input = "
...
//
#[test]
fn dup_deposit_withdraw() -> DynResult {
    let input = "
...
//
#[test]
fn withdraw_too_much() -> DynResult {
    let input = "
...
//
#[test]
fn dispute_after_withdraw() -> DynResult {
    let input = "
